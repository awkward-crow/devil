...
(define-key evil-normal-state-map "Q" 'evil-change-line)

(define-key evil-normal-state-map "e" 'evil-delete-char)
;; (define-key evil-normal-state-map "e" 'delete-char)
 
;; (define-key evil-normal-state-map "E" 'evil-delete-line)
(define-key evil-normal-state-map "E" 'kill-whole-line)

(define-key evil-normal-state-map "u" 'kill-word)
(define-key evil-normal-state-map "U" 'kill-line)

(define-key evil-normal-state-map "o" 'evil-insert)
(define-key evil-normal-state-map "O" 'evil-insert-line)
(define-key evil-normal-state-map "I" 'evil-join)
;; (define-key evil-normal-state-map "m" 'evil-set-marker)
(define-key evil-normal-state-map "p" 'evil-open-below)
(define-key evil-normal-state-map "P" 'evil-open-above)
...
(define-key evil-normal-state-map "i" 'evil-replace)
;; (define-key evil-normal-state-map "R" 'evil-replace-state)
(define-key evil-normal-state-map "q" 'evil-substitute)
...
(define-key evil-normal-state-map "j" 'evil-repeat)
...
(define-key evil-normal-state-map [(meta \ )] 'evil-force-normal-state)
...
;; undo
(define-key evil-normal-state-map "d" 'undo)
(define-key evil-normal-state-map "\C-r" 'redo)

;; and what about undo-tree ??
...
(define-key evil-motion-state-map "n" 'evil-backward-word-begin)
;; (define-key evil-motion-state-map "B" 'evil-backward-WORD-begin)
(define-key evil-motion-state-map "m" 'evil-forward-word-end)
...
(define-key evil-motion-state-map "W" 'evil-goto-line)
(define-key evil-motion-state-map "r" 'evil-backward-char)
(define-key evil-motion-state-map "H" 'evil-window-top)
(define-key evil-motion-state-map "t" 'evil-next-line)
(define-key evil-motion-state-map "c" 'evil-previous-line)
(define-key evil-motion-state-map "g" 'evil-forward-char)
...
(define-key evil-motion-state-map "y" 'evil-find-char-to)
(define-key evil-motion-state-map "Y" 'evil-find-char-to-backward)
(define-key evil-motion-state-map "h" 'evil-forward-word-begin)
...
;; (define-key evil-motion-state-map "gE" 'evil-backward-WORD-end)
(define-key evil-motion-state-map "w" 'evil-goto-first-line)
...
(define-key evil-motion-state-map [tab] 'evil-jump-item)
...
(define-key evil-motion-state-map "x" 'evil-search-forward)
;; (define-key evil-motion-state-map ";" 'evil-repeat-find-char)
(define-key evil-motion-state-map "X" 'evil-search-backward)
(define-key evil-motion-state-map "|" 'evil-goto-column)
(define-key evil-motion-state-map "^" 'evil-first-non-blank)
(define-key evil-motion-state-map "N" 'evil-first-non-blank)
...
(define-key evil-motion-state-map "C" 'evil-scroll-up)
...
(define-key evil-motion-state-map "K" 'evil-visual-char)
(define-key evil-motion-state-map "k" 'evil-visual-line)
...
(define-key evil-visual-state-map [(meta \ )] 'evil-exit-visual-state)

(define-key evil-visual-state-map "h" 'evil-forward-word-end)
(define-key evil-visual-state-map "," 'evil-yank)
...
(define-key evil-insert-state-map [(meta \ )] 'evil-normal-state)
...
(define-key evil-replace-state-map [(meta \ )] 'evil-normal-state)
...
(define-key evil-ex-completion-map [(meta \ )] 'abort-recursive-edit)
